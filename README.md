...
| **File** | **Source** |
| :--- | :--- |
| `Annotation_eRNA_in_Super_enhancer_all.bed` | **TCeA** |
| `eRNA_standard_500bp.saf` | Generated from the `.bed` file above |
...
**File descriptions:**
- **`Annotation_eRNA_in_Super_enhancer_all.bed`** — ~300k eRNA loci within ENCODE super-enhancer regions; used to generate the SAF quantification file.
- **`eRNA_standard_500bp.saf`** — Custom SAF file with each eRNA locus symmetrically expanded ±500 bp; directly used by `featureCounts` in Script 0.
