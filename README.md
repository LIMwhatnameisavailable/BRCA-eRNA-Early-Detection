...
| :--- | :--- | :--- |
| `Annotation_eRNA_in_Super_enhancer_all.bed` | **TCeA** | ~300k eRNA loci within ENCODE super-enhancer regions; used to generate the SAF quantification file |
| `eRNA_standard_500bp.saf` | Generated from the `.bed` file above | Custom SAF file with each eRNA locus symmetrically expanded ±500 bp; directly used by `featureCounts` in Script 0 |
| `SraRunTable_GSE225846.csv` | **NCBI SRA** (GEO: GSE225846) | SRA run metadata for external cohort 1; used for sample annotation and stage filtering |
| `SraRunTable_GSE229571.csv` | **NCBI SRA** (GEO: GSE229571) | SRA run metadata for external cohort 2; used for sample annotation and stage filtering |
| `Normal_like_samples.csv` | Generated by `Prognosis_R/R_Scripts/8_Quality_Control_for_Normal_Like_References.R | Purified normal reference sample list after GTEx-based field cancerization filtering` |
| `TCGA-BRCA.clinical.tsv` | **UCSC Xena** · GDC TCGA Breast Cancer (BRCA) | Phenotype data used for Stage I/II filtering |
